Создать папку и перекинуть файл docker-compose.yaml
...
STICKER_SET_NAME - название стикерпака (в конце названия стикерпака обязательно должно быть "by_{botname}")
